...
public class BoardUtility {
    ...
    public static void spawnTankAI(String difficulty, boolean powerUp) {
        ...
        if (randomPos == 0) {
            animations.add(new TankSpawn(2 * 25, 1 * 25));
            TankAI AI = new TankAI(2 * 25, 1 * 25, difficulty, type, powerUp);
            enemy.add(AI);
        } else if (randomPos == 1) {
            animations.add(new TankSpawn(14 * 25, 1 * 25));
            TankAI AI = new TankAI(14 * 25, 1 * 25, difficulty, type, powerUp);
            enemy.add(AI);
        } else {
            animations.add(new TankSpawn(26 * 25, 1 * 25));
            TankAI AI = new TankAI(26 * 25, 1 * 25, difficulty, type, powerUp);
            enemy.add(AI);
        }
    }
